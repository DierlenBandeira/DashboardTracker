...
const MAX_REPLAY_CANVAS_CSS_WIDTH = 64000;
const MAX_CANVAS_PIXEL_WIDTH = 32760;
const MAX_DEVICE_PIXEL_RATIO = 1.5;
const MAX_REPLAY_DEVICE_PIXEL_RATIO = 1;
const MIN_REPLAY_DEVICE_PIXEL_RATIO = 0.5;
const LARGE_REPLAY_CANVAS_CSS_WIDTH = 18000;
const STEP_SEC = 10;
const POLL_MS = 10000;
const REPLAY_STEP_MS = 2000;
const DEFAULT_X_ZOOM = 1;
const MIN_X_ZOOM = 1;
const MAX_X_ZOOM = 4;
const X_ZOOM_STEP = 1.1;
